...
recipe.prototype.pasta = function(){
  $("#baseOutput").append("<h2>How to cook your Pasta:</h2>-Bring a pot of water with a dash of salt to a boil.<br>-Toss uncooked pasta into your pot, and let boil for 5-20 minutes, constantly check the tenderness of your pasta until it is ready to eat.<br>-Strain Pasta into colander, set aside and you're pasta is now cooked!<br>-Pro Tip: Run cold water over the pasta while it's in the colander if you think it might be over cooked.");

}
recipe.prototype.quinoa = function(){
  $("#baseOutput").append("<h2>How to cook Quinoa:</h2>-The ratio for cooking quinoa is a lot like cooking rice, it's generally 2 to 1. I.E. for every cup quinoa you'll need two cups of water!<br>-Once the desired amount of water is boiling, add the quinoa, stir, cover, and turn to low for 15-20 minutes until all of the liquid is gone.<br>-Optional: you can also season your rice by adding a little slice of butter, or whatever spices you have on hand. <br>-After 15-20 minutes, stir your quinoa and you're ready to go!");
}
//instruction on how to cook the proteins
recipe.prototype.beef = function(){
  $("#proteinOutput").append("<h2>How to cook Beef:</h2>-Dice your beef into 1/4 inch cubes.<br>-Optional: Marinade your beef in 3 parts sauce, 1 part oil.<br>-Sear on a hot pan with a little bit of oil and season to taste.<br>-Make sure meat is cooked to desired doneness.<br>-Your beef is ready for your dish!");
}
